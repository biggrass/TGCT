...
\bibitem{b3} Wang J, Wang S, Cui Q, et al. Local-based active classification of test report to assist crowdsourced testing[C]//2016 31st IEEE/ACM International Conference on Automated Software Engineering (ASE). IEEE, 2016: 190-201.
...
\bibitem{b9} Feng Y, Jones J A, Chen Z, et al. Multi-objective test report prioritization using image understanding[C]//2016 31st IEEE/ACM International Conference on Automated Software Engineering (ASE). IEEE, 2016: 202-213.
\end{thebibliography}
\end{document}
